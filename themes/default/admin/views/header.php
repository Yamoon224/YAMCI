                        ...
                        if ($Owner || $Admin) {
                            ...
                            <li class="mm_returns">
                                <a class="dropmenu" href="#">
                                    ...
                                    <span class="text"> <?= lang('Retournés'); ?> </span>
                                    <span class="chevron closed"></span>
                                </a>
                                <ul>
                                    <li id="returns_index">
                                        <a class="submenu" href="<?= admin_url('returns'); ?>">
                                            <i class="fa fa-random"></i><span class="text"> <?= lang('Liste des retours'); ?></span>
                                        </a>
                                    </li>
                                    <li id="returns_add">
                                        <a class="submenu" href="<?= admin_url('returns/add'); ?>">
                                            <i class="fa fa-plus-circle"></i><span class="text"> <?= lang('Ajouter'); ?></span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                                ...
                                <ul>
                                    ...
                                    <li id="reports_categories">
                                        <a href="<?= admin_url('reports/categories') ?>">
                                            <i class="fa fa-folder-open"></i><span class="text"> <?= lang('Rapport sur les catégories'); ?></span>
                                        </a>
                                    </li>
                                    ...
                                    <li id="reports_sales">
                                        <a href="<?= admin_url('reports/sales') ?>">
                                            <i class="fa fa-money"></i><span class="text"> <?= lang('sales_report'); ?></span>
                                        </a>
                                    </li>
                                    <li id="reports_returns">
                                        <a href="<?= admin_url('reports/returns') ?>">
                                            <i class="fa fa-random"></i><span class="text"> <?= lang('Les retours'); ?></span>
                                        </a>
                                    </li>
                                    ...
                                    <li id="reports_tax">
                                        <a href="<?= admin_url('reports/tax') ?>">
                                            <i class="fa fa-area-chart"></i><span class="text"> <?= lang('Rapport de taxe'); ?></span>
                                        </a>
                                    </li>
                            ...
                            <li class="mm_reports">
                                ...
                                <ul>
                                    ...
                                    <li id="reports_returns">
                                        <a href="<?= admin_url('reports/returns') ?>">
                                            <i class="fa fa-random"></i><span class="text"> <?= lang('returns_report'); ?></span>
                                        </a>
                                    </li>
                                        <?php
                                    }
