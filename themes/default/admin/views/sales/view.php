                    ...
                    <table class="table table-bordered table-hover table-striped print-table order-table">
                        ...
                        foreach ($rows as $row) :
                            ...
                            <tr>
                                ...
                                <td style="width: 100px; text-align:center; vertical-align:middle;"><?= $this->sma->formatQuantity($row->unit_quantity) . ' ' . ($inv->sale_status == 'returned' ? $row->base_unit_code : $row->product_unit_code); ?></td>
                                <?php
                                if ($Settings->product_serial) {
                        ...
                        <tr>
                            <td colspan="<?= $col; ?>"
                                style="text-align:right; font-weight:bold;"><?= lang('Reste à payer'); ?>
                                (<?= $default_currency->code; ?>)
                            </td>
