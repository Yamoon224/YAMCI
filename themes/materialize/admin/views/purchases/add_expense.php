    ...
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="myModalLabel">
                <span class="icon-base ri ri-add-circle-line icon-20px me-2 text-primary"></span><?= lang('add_expense') ?>
            </h5>
        ...
        <div class="modal-body">
            ...
            <div class="mb-3">
                ...
                <?= form_input('reference', ($_POST['reference'] ?? $exnumber), 'class="form-control" id="reference"'); ?>
            </div>
            ...
            <div class="mb-3">
                ...
                echo form_dropdown('category', $ct, set_value('category'), 'class="form-select select2" id="category" data-placeholder="' . lang('select') . ' ' . lang('category') . '"');
                ?>
            </div>
            ...
            <div class="mb-3">
                ...
                echo form_dropdown('warehouse', $wh, ($_POST['warehouse'] ?? ''), 'id="warehouse" class="form-select select2" data-placeholder="' . lang('select') . ' ' . lang('warehouse') . '"');
                ?>
            </div>
            ...
            <div class="mb-3">
                ...
                <?= form_textarea('note', ($_POST['note'] ?? ''), 'class="form-control" id="note" style="height:80px;"'); ?>
            </div>

        </div>
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><?= lang('close') ?></button>
            <?= form_submit('add_expense', lang('add_expense'), 'class="btn btn-primary"'); ?>
        </div>
        <?= form_close(); ?>
    </div>
</div>
