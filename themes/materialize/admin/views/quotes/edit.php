...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        localStorage.setItem('qunote',    '<?= addslashes(str_replace(["\r", "\n"], '', $this->sma->decode_html($inv->note))); ?>');
...
<?php
$attrib = ['data-toggle' => 'validator', 'role' => 'form', 'class' => 'edit-qu-form', 'id' => 'quoteEditForm'];
...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
  <div class="d-flex flex-column justify-content-center">
    <h4 class="mb-1"><?= lang('edit_quote') ?: 'Modifier le devis' ?></h4>
    <?php if (isset($inv) && !empty($inv->reference_no)): ?>
    <p class="mb-0 text-muted"><?= lang('reference_no') ?>: <span class="text-primary fw-semibold"><?= htmlspecialchars($inv->reference_no) ?></span></p>
    <?php endif; ?>
    <nav aria-label="breadcrumb" class="mt-2">
      <ol class="breadcrumb breadcrumb-style1 mb-0">
        ...
        <li class="breadcrumb-item active" aria-current="page"><?= lang('edit_quote') ?></li>
      </ol>
    </nav>
  </div>
  <div class="d-flex align-content-center flex-wrap gap-2">
    <a href="<?= admin_url('quotes/view/' . $id) ?>" class="btn btn-outline-info">
    ...
    <button type="button" class="btn btn-primary" onclick="$('#quoteEditForm').submit();">
...
<div class="card mb-4">
    ...
    <div class="card-body">
        <div class="row g-3">
            ...
            <div class="col-md-4">
                <label for="quref" class="form-label"><?= lang('reference_no') ?> <span class="text-danger">*</span></label>
                <?php echo form_input('reference_no', ($_POST['reference_no'] ?? ''), 'class="form-control" id="quref" required="required"'); ?>
            </div>
            ...
            <div class="col-md-4">
                ...
                <?php
                $st = ['pending' => lang('pending'), 'sent' => lang('sent'), 'completed' => lang('completed')];
            ...
            <div class="col-md-4">
                ...
                <?php echo form_input('discount', ($_POST['discount'] ?? ''), 'class="form-control" id="qudiscount"' . (($Owner || $Admin || $this->session->userdata('allow_discount')) ? '' : ' readonly="true"')); ?>
            </div>
            <?php } ?>
            ...
            <div class="col-md-4">
                ...
                <div class="input-group">
                    ...
                    <a href="#" id="view-supplier" class="btn btn-outline-secondary no-print external"
...
<div class="d-flex gap-2 justify-content-end mb-5">
    ...
    <?php echo form_submit('edit_quote', lang('submit'), 'id="edit_quote" class="btn btn-warning"'); ?>
</div>
