...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
  <div class="d-flex flex-column justify-content-center">
    <h4 class="mb-1">
        <i class="ri ri-equalizer-line me-2" style="font-size:24px;vertical-align:-0.2em"></i>
        <?php echo lang('adjustments_report') ?: 'Rapport des ajustements'; ?>
    ...
    <nav aria-label="breadcrumb" class="mt-2">
      <ol class="breadcrumb breadcrumb-style1 mb-0">
        ...
        <li class="breadcrumb-item active"><?php echo lang('adjustments_report') ?: 'Rapport des ajustements'; ?></li>
      </ol>
    </nav>
    </div>
...
<div class="card mb-4" id="filterCard">
  ...
  <div class="card-body">
    <?php echo admin_form_open('reports/adjustments', ['id' => 'reportForm', 'autocomplete' => 'off']); ?>
    <div class="row g-4">
    ...
    <div class="mt-4 d-flex gap-3">
      ...
      <a href="<?php echo admin_url('reports/adjustments'); ?>" class="btn btn-outline-secondary"><?php echo lang('reset') ?: 'Réinitialiser'; ?></a>
    </div>
    <?php echo form_close(); ?>
  </div>
</div>
...
<div class="card">
  <div class="card-datatable table-responsive">
    <table id="AdjData" class="table datatables-ajax border-top">
      <thead>
        <tr>
          ...
          <th><?php echo lang('products') ?: 'Produits'; ?></th>
        </tr>
      </thead>
      <tbody>
...
(function () {
  ...
  var oTable = $('#AdjData').DataTable({
    ...
    order: [[0, 'desc']],
    ajax: {
      url: '<?php echo admin_url('reports/getAdjustmentReport/?v=1' . $v); ?>',
      type: 'POST',
      data: function (d) {
    ...
    columns: [
      ...
      null, null, null,
      { render: function (d) { return d ? decodeURIComponent(d) : ''; } },
      { orderable: false, render: function (d) { return d; } }
    ],
    rowCallback: function (row, data) {
      row.id = data[6];
      row.className += ' adjustment_link2';
    },
  ...
  document.getElementById('xls').addEventListener('click', function (e) {
    e.preventDefault();
    window.location.href = '<?php echo admin_url('reports/getAdjustmentReport/0/xls/?v=1' . $v); ?>';
  });
})();
</script>
