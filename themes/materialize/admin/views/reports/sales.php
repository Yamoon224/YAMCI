...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
  <div class="d-flex flex-column justify-content-center">
    <h4 class="mb-1">
        <i class="ri ri-shopping-cart-line me-2" style="font-size:24px;vertical-align:-0.2em"></i>
        <?php echo lang('sales_report') ?: 'Rapport des ventes'; ?>
    ...
    <nav aria-label="breadcrumb" class="mt-2">
      <ol class="breadcrumb breadcrumb-style1 mb-0">
        ...
        <li class="breadcrumb-item active"><?php echo lang('sales_report') ?: 'Rapport des ventes'; ?></li>
      </ol>
    </nav>
    </div>
...
<div class="card mb-4" id="filterCard">
  ...
  <div class="card-body">
    <?php echo admin_form_open('reports/sales', ['id' => 'reportForm', 'autocomplete' => 'off']); ?>
    <div class="row g-4">
      <div class="col-sm-6 col-md-4">
        <div class="form-floating form-floating-outline">
          <?php echo form_input('sproduct', isset($_POST['sproduct']) ? $_POST['sproduct'] : '', 'class="form-control" id="suggest_product" placeholder="Rechercher un produit"'); ?>
      ...
      <div class="col-sm-6 col-md-4">
        <div class="form-floating form-floating-outline">
          <?php echo form_input('serial', '', 'class="form-control" id="serial" placeholder="N° série"'); ?>
          <label for="serial"><?php echo lang('serial_no') ?: 'N° de série'; ?></label>
        </div>
      </div>
      <?php endif; ?>
      <div class="col-sm-6 col-md-4">
    ...
    <div class="mt-4 d-flex gap-3">
      ...
      <a href="<?php echo admin_url('reports/sales'); ?>" class="btn btn-outline-secondary"><?php echo lang('reset') ?: 'Réinitialiser'; ?></a>
    </div>
    <?php echo form_close(); ?>
  </div>
</div>
...
<div class="card">
  <div class="card-datatable table-responsive">
    <table id="SlRData" class="table datatables-ajax border-top">
      <thead>
        <tr>
          ...
          <th><?php echo lang('payment_status') ?: 'Statut paiement'; ?></th>
        </tr>
      </thead>
      <tbody>
...
(function () {
  ...
  var oTable = $('#SlRData').DataTable({
    ...
    order: [[0, 'desc']],
    ajax: {
      url: '<?php echo admin_url('reports/getSalesReport/?v=1' . $v); ?>',
      type: 'POST',
      data: function (d) {
    ...
    columns: [
      ...
      null, null, null,
      { searchable: false, render: function (d) { return d; } },
    ...
    rowCallback: function (row, data) {
      row.id = data[9];
      row.className += data[5] > 0 ? ' invoice_link2' : ' invoice_link2 table-warning';
    },
  ...
  document.getElementById('xls').addEventListener('click', function (e) {
    e.preventDefault();
    window.location.href = '<?php echo admin_url('reports/getSalesReport/0/xls/?v=1' . $v); ?>';
  });
})();
</script>
