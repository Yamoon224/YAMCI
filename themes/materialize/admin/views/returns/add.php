...
<?php
$attrib = ['data-toggle' => 'validator', 'role' => 'form', 'id' => 'returnAddForm'];
...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
  <div class="d-flex flex-column justify-content-center">
    <h4 class="mb-1"><i class="ri ri-arrow-go-back-line me-2" style="font-size:24px;vertical-align:-0.2em"></i><?= lang('add_return') ?: 'Nouveau retour' ?></h4>
    <p class="mb-0 text-muted">Enregistrez un retour de marchandise</p>
    <nav aria-label="breadcrumb" class="mt-2">
      <ol class="breadcrumb breadcrumb-style1 mb-0">
        ...
        <li class="breadcrumb-item active" aria-current="page"><?= lang('add_return') ?></li>
      </ol>
    </nav>
  </div>
  <div class="d-flex align-content-center flex-wrap gap-2">
    ...
    <button type="button" class="btn btn-primary" onclick="$('#returnAddForm').submit();">
    ...
    <div class="card-body">
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <?= form_input('date', (isset($_POST['date']) ? $_POST['date'] : ''), 'class="form-control datetime" id="redate" required') ?>
            </div>
            <?php } ?>

            <div class="col-md-4">
                <label for="reref" class="form-label"><?= lang('reference_no') ?></label>
                <?= form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : ''), 'class="form-control" id="reref"') ?>
            </div>
            ...
            <div class="col-md-4">
                ...
                echo form_dropdown('biller', $bl, (isset($_POST['biller']) ? $_POST['biller'] : $Settings->default_biller),
            ...
            <div class="col-md-4">
                ...
                echo form_dropdown('warehouse', $wh, (isset($_POST['warehouse']) ? $_POST['warehouse'] : $Settings->default_warehouse),
            ...
            <div class="col-md-4">
                ...
                echo form_dropdown('order_tax', $tr, (isset($_POST['order_tax']) ? $_POST['order_tax'] : $Settings->default_tax_rate2),
