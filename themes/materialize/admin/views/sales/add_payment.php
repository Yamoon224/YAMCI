...
<script type="text/javascript">
    $(document).ready(function () {
            ...
            if (cn) {
                $.ajax({
                    ...
                    success: function (data) {
                        if (data === false) {
                            $('#gift_card_no').closest('.form-floating').addClass('has-error');
                            ...
                            $('#gift_card_no').closest('.form-floating').removeClass('has-error');
                        }
                    }
                });
            }
        ...
        $(document).on('change', '.paid_by', function () {
            ...
            if (p_val == 'cash') {
                $('.pcheque_1').hide(); $('.pcc_1').hide(); $('.pcash_1').show(); $('.ngc').show(); $('.gc').hide(); $('#amount_1').focus();
            } else if (p_val == 'CC') {
                $('.pcheque_1').hide(); $('.pcash_1').hide(); $('.pcc_1').show(); $('.ngc').show(); $('.gc').hide(); $('#pcc_no_1').focus();
            } else if (p_val == 'Cheque') {
                $('.pcc_1').hide(); $('.pcash_1').hide(); $('.pcheque_1').show(); $('.ngc').show(); $('.gc').hide(); $('#cheque_no_1').focus();
            } else if (p_val == 'gift_card') {
                $('.pcheque_1').hide(); $('.pcc_1').hide(); $('.pcash_1').hide(); $('.ngc').hide(); $('.gc').show(); $('#gift_card_no').focus();
            } else {
                $('.pcheque_1').hide(); $('.pcc_1').hide(); $('.pcash_1').hide(); $('.ngc').show(); $('.gc').hide();
            }
        });
