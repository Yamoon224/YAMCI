...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        localStorage.setItem('slnote',           '<?= addslashes(str_replace(["\r", "\n"], '', $this->sma->decode_html($inv->note))); ?>');
        localStorage.setItem('slinnote',         '<?= addslashes(str_replace(["\r", "\n"], '', $this->sma->decode_html($inv->staff_note))); ?>');
...
<?php
$attrib = ['data-toggle' => 'validator', 'role' => 'form', 'class' => 'edit-so-form', 'id' => 'salesEditForm'];
...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
  <div class="d-flex flex-column justify-content-center">
    <h4 class="mb-1"><?= lang('edit_sale') ?: 'Modifier la vente' ?></h4>
    <p class="mb-0 text-muted">
      <?= lang('reference_no') ?>: <span class="text-primary fw-semibold"><?= htmlspecialchars($inv->reference_no) ?></span>
    </p>
    <nav aria-label="breadcrumb" class="mt-2">
      <ol class="breadcrumb breadcrumb-style1 mb-0">
        ...
        <li class="breadcrumb-item active" aria-current="page"><?= htmlspecialchars($inv->reference_no) ?></li>
      </ol>
    </nav>
  </div>
  <div class="d-flex align-content-center flex-wrap gap-2">
    <a href="<?= admin_url('sales/view/' . $inv->id) ?>" class="btn btn-outline-info">
    ...
    <button type="button" class="btn btn-primary" onclick="$('#salesEditForm').submit();">
    ...
    <div class="card-body">
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <?php echo form_input('date', ($_POST['date'] ?? $this->sma->hrld($inv->date)), 'class="form-control datetime" id="sldate" required="required"'); ?>
            </div>
            <?php } ?>

            <div class="col-md-4">
                <label for="slref" class="form-label"><?= lang('reference_no') ?> <span class="text-danger">*</span></label>
                <?php echo form_input('reference_no', ($_POST['reference_no'] ?? $inv->reference_no), 'class="form-control" id="slref" required="required"'); ?>
            </div>
            ...
            <div class="col-md-4">
                ...
                echo form_dropdown('biller', $bl, ($_POST['biller'] ?? $inv->biller_id),
            ...
            <div class="col-md-4">
                ...
                <?php
                $sst = ['pending' => lang('pending'), 'completed' => lang('completed')];
                echo form_dropdown('sale_status', $sst, ($_POST['sale_status'] ?? $inv->sale_status), 'class="form-select" required="required" id="slsale_status"');
                ?>
            </div>

            <div class="col-md-4">
                <label for="slpayment_term" class="form-label"><?= lang('payment_term') ?></label>
                <?php echo form_input('payment_term', ($_POST['payment_term'] ?? $inv->payment_term), 'class="form-control" id="slpayment_term" title="' . lang('payment_term_tip') . '"'); ?>
            </div>
    ...
    <div class="card-body">
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                echo form_dropdown('warehouse', $wh, ($_POST['warehouse'] ?? $inv->warehouse_id),
            ...
            <div class="col-md-4">
                ...
                <div class="input-group">
                    ...
                    <a href="#" id="removeReadonly" class="btn btn-outline-secondary no-print" title="<?= lang('unlock') ?>">
    ...
    <div class="card-body">
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                echo form_dropdown('order_tax', $tr, ($_POST['order_tax'] ?? $inv->order_tax_id),
            ...
            <div class="col-md-4">
                ...
                <?php echo form_input('order_discount', ($_POST['order_discount'] ?? ''), 'class="form-control" id="sldiscount"' . ($allow_discount ? '' : ' readonly="true"')); ?>
            </div>
            <?php } ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3">
                    ...
                    <?php if ($Settings->product_serial) { ?>
                    <div class="col-12">
                        <label for="mserial" class="form-label"><?= lang('product_serial') ?></label>
