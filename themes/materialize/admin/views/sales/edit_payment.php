    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row g-3">
                ...
                <input type="hidden" value="<?= $payment->sale_id ?>" name="sale_id" />
            </div>
                ...
                <div class="col-sm-6">
                    <div class="form-floating form-floating-outline">
                        <input name="amount-paid" type="text" id="amount_1"
                               ...
                               class="pa form-control kb-pad amount" placeholder=" " />
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on('change', '.paid_by', function () { applyPaymentMode($(this).val()); });
