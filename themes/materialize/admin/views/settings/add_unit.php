    ...
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="myModalLabel">
                <i class="icon-base ri ri-ruler-line icon-20px me-2 text-primary"></i><?= lang('add_unit') ?>
            </h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>

        <?php $attrib = ['role' => 'form', 'id' => 'addUnitForm'];
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    <div class="form-floating form-floating-outline mb-3">
                        <?= form_input('code', set_value('code'), 'class="form-control" id="code" placeholder="' . lang('unit_code') . '" required="required"') ?>
                        <label for="code"><?= lang('unit_code') ?> <span class="text-danger">*</span></label>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-floating form-floating-outline mb-3">
                        <?= form_input('name', set_value('name'), 'class="form-control" id="name" placeholder="' . lang('unit_name') . '" required="required"') ?>
                ...
                <div class="col-12">
                    ...
                    echo form_dropdown('base_unit', $opts, set_value('base_unit'), 'class="form-select select2" id="base_unit" data-placeholder="' . lang('select') . ' ' . lang('unit') . '"');
                    ?>
                </div>
                ...
                <div id="measuring" class="col-12" style="display:none;">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            echo form_dropdown('operator', $oopts, set_value('operator'), 'class="form-select" id="operator"');
                            ?>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating form-floating-outline">
                                <?= form_input('operation_value', set_value('operation_value'), 'class="form-control" id="operation_value" placeholder="' . lang('operation_value') . '"') ?>
