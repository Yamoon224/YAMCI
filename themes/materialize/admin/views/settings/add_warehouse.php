    ...
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="myModalLabel">
                <i class="icon-base ri ri-store-2-line icon-20px me-2 text-primary"></i><?= lang('add_warehouse') ?>
            </h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>

        <?php $attrib = ['role' => 'form', 'id' => 'addWarehouseForm'];
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    <div class="form-floating form-floating-outline mb-3">
                        <?= form_input('code', '', 'class="form-control" id="code" placeholder="' . lang('code') . '" required="required"') ?>
                ...
                <div class="col-12">
                    ...
                    echo form_dropdown('price_group', $pgs, $Settings->price_group, 'class="form-select select2" id="price_group" data-placeholder="' . lang('select') . ' ' . lang('price_group') . '"');
                    ?>
                </div>
                <div class="col-md-6">
                    <div class="form-floating form-floating-outline mb-3">
                ...
                <div class="col-12">
                    <div class="form-floating form-floating-outline mb-3">
                        <?= form_textarea('address', '', 'class="form-control" id="address" placeholder="' . lang('address') . '" required="required" rows="3"') ?>
