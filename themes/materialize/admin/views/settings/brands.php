...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
    <div class="d-flex flex-column justify-content-center">
        <h4 class="mb-1"><i class="ri ri-bookmark-line me-2" style="font-size:24px;vertical-align:-0.2em"></i><?php echo $page_title ?? (lang('brands') ?: 'Marques'); ?></h4>
        <p class="mb-0 text-muted">Marques et fabricants associés à vos produits.</p>
        <nav aria-label="breadcrumb" class="mt-2">
            <ol class="breadcrumb breadcrumb-style1 mb-0">
                ...
                <li class="breadcrumb-item active"><?= lang('brands') ?: 'Marques'; ?></li>
            </ol>
        </nav>
    </div>
    <div class="d-flex gap-2 align-content-center flex-wrap">
        <a href="<?= admin_url('system_settings/add_brand') ?>"
           class="btn btn-primary"
           data-bs-toggle="modal" data-bs-target="#ajaxModal">
            <i class="ri ri-add-line me-1" style="font-size:16px"></i><?= lang('add_brand') ?: 'Ajouter une marque'; ?>
        </a>
    </div>
</div>
    ...
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li>
                    <a class="dropdown-item" href="<?= admin_url('system_settings/import_brands') ?>"
                       data-bs-toggle="modal" data-bs-target="#ajaxModal">
                        <span class="icon-base ri ri-upload-2-line me-2 icon-16px"></span>
                        <?= lang('import_brands') ?: 'Importer'; ?>
                    </a>
                </li>
                <li>
