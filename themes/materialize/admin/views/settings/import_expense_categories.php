  ...
  <div class="modal-content">
    <div class="modal-header">
      <h5 class="modal-title">
        ...
        <?php echo lang('import_expense_categories') ?: 'Importer catégories dépenses'; ?>
      </h5>
      <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
    </div>
    <?php echo admin_form_open_multipart('system_settings/import_expense_categories'); ?>
    <div class="modal-body">
      ...
      <a href="<?php echo base_url(); ?>assets/csv/sample_expense_categories.csv" class="btn btn-sm btn-outline-primary mb-3">
        <span class="icon-base ri ri-download-line me-1"></span><?php echo lang('download_sample_file') ?: 'Exemple'; ?>
      </a>
      <div>
        <label class="form-label" for="csv_file_expcats"><?php echo lang('upload_file') ?: 'Fichier'; ?> <span class="text-danger">*</span></label>
        <input type="file" class="form-control" id="csv_file_expcats" name="csv_file" accept=".csv" required />
      </div>
    </div>
