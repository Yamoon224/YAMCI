...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
    <div class="d-flex flex-column justify-content-center">
        <h4 class="mb-1"><i class="ri ri-percent-line me-2" style="font-size:24px;vertical-align:-0.2em"></i><?php echo $page_title ?? (lang('tax_rates') ?: 'Taux de taxe'); ?></h4>
        <p class="mb-0 text-muted">Taux de TVA et taxes applicables aux ventes et achats.</p>
        <nav aria-label="breadcrumb" class="mt-2">
            <ol class="breadcrumb breadcrumb-style1 mb-0">
                ...
                <li class="breadcrumb-item active"><?= lang('tax_rates') ?: 'Taux de taxe'; ?></li>
            </ol>
        </nav>
    </div>
    <div class="d-flex gap-2 align-content-center flex-wrap">
        <a href="<?= admin_url('system_settings/add_tax_rate') ?>"
           class="btn btn-primary"
           data-bs-toggle="modal" data-bs-target="#ajaxModal">
            <i class="ri ri-add-line me-1" style="font-size:16px"></i><?= lang('add_tax_rate') ?: 'Ajouter un taux'; ?>
        </a>
    </div>
</div>
...
<div class="card">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li>
                    <a class="dropdown-item text-danger" href="#" id="btn-delete" data-action="delete">
                        ...
                        <?= lang('delete_tax_rates') ?: 'Supprimer'; ?>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <div class="card-datatable table-responsive">
        <table id="TaxRateTable" class="table table-hover">
            <thead>
                <tr>
            ...
            <tbody>
                <tr>
                    <td colspan="6" class="text-center"><?= lang('loading_data_from_server') ?></td>
                </tr>
            </tbody>
        </table>
    </div>
...
$(document).ready(function () {
    ...
    var oTable = $('#TaxRateTable').dataTable({
        "aaSorting": [[1, "asc"]],
