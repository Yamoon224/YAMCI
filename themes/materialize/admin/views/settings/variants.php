...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
  <div class="d-flex flex-column justify-content-center">
    <h4 class="mb-1"><i class="ri ri-list-check me-2" style="font-size:24px;vertical-align:-0.2em"></i><?php echo $page_title ?? (lang('variants') ?: 'Variantes'); ?></h4>
    <p class="mb-0 text-muted">Déclinaisons produits (taille, couleur, format…)</p>
    <nav aria-label="breadcrumb" class="mt-2">
      <ol class="breadcrumb breadcrumb-style1 mb-0">
        ...
        <li class="breadcrumb-item active"><?php echo $page_title ?? (lang('variants') ?: 'Variantes'); ?></li>
      </ol>
    </nav>
  </div>
  <div class="d-flex gap-2 align-content-center flex-wrap">
    <a href="<?php echo admin_url('system_settings/add_variant'); ?>"
       class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">
      <i class="ri ri-add-line me-1" style="font-size:16px"></i><?php echo lang('add_variant') ?: 'Ajouter une variante'; ?>
    </a>
  </div>
</div>
...
<div class="card">
  <div class="card-datatable table-responsive">
    <table id="CURData" class="table datatables-ajax border-top">
      <thead>
        <tr>
...
(function () {
  ...
  $('#CURData').DataTable({
    ...
    order: [[1, 'asc']],
    ajax: {
      url: '<?php echo admin_url('system_settings/getVariants'); ?>',
      type: 'POST',
      data: function (d) {
