...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
    <div class="d-flex flex-column justify-content-center">
        <h4 class="mb-1"><i class="ri ri-store-2-line me-2" style="font-size:24px;vertical-align:-0.2em"></i><?php echo $page_title ?? (lang('warehouses') ?: 'Entrepôts'); ?></h4>
        <p class="mb-0 text-muted">Points de stockage et de vente reliés à votre activité.</p>
        <nav aria-label="breadcrumb" class="mt-2">
            <ol class="breadcrumb breadcrumb-style1 mb-0">
                ...
                <li class="breadcrumb-item active"><?= lang('warehouses') ?: 'Entrepôts'; ?></li>
            </ol>
        </nav>
    </div>
    <div class="d-flex gap-2 align-content-center flex-wrap">
        <a href="<?= admin_url('system_settings/add_warehouse') ?>"
           class="btn btn-primary"
           data-bs-toggle="modal" data-bs-target="#ajaxModal">
            <i class="ri ri-add-line me-1" style="font-size:16px"></i><?= lang('add_warehouse') ?: 'Ajouter un entrepôt'; ?>
        </a>
    </div>
</div>
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li>
                    <a class="dropdown-item text-danger" href="#" id="btn-delete" data-action="delete">
                        ...
                        <?= lang('delete_warehouses') ?: 'Supprimer'; ?>
                    </a>
                </li>
            </ul>
        </div>
        ...
        <table id="WarehouseTable" class="table table-hover">
            <thead>
                <tr>
                    ...
                    <th style="width:50px;" class="text-center"><?= lang('map') ?></th>
                    <th><?= lang('code') ?></th>
                    <th><?= lang('name') ?></th>
            ...
            <tbody>
                <tr>
                    <td colspan="9" class="text-center"><?= lang('loading_data_from_server') ?></td>
                </tr>
            </tbody>
        </table>
    </div>
...
$(document).ready(function () {
    var oTable = $('#WarehouseTable').dataTable({
